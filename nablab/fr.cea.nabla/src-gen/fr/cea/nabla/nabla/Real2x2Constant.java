 ...
 * </p>
 * <ul>
 *   <li>{@link fr.cea.nabla.nabla.Real2x2Constant#getX <em>X</em>}</li>
 *   <li>{@link fr.cea.nabla.nabla.Real2x2Constant#getY <em>Y</em>}</li>
 * </ul>
 *
 * @see fr.cea.nabla.nabla.NablaPackage#getReal2x2Constant()
 * @model
 * @generated
 */
public interface Real2x2Constant extends Expression
{
   ...
   * @see fr.cea.nabla.nabla.NablaPackage#getReal2x2Constant_X()
  ...
  /**
   * Sets the value of the '{@link fr.cea.nabla.nabla.Real2x2Constant#getX <em>X</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.cea.nabla.nabla.NablaPackage#getReal2x2Constant_Y()
   * @model containment="true"
   * @generated
   */
  Real2Constant getY();
  ...
  /**
   * Sets the value of the '{@link fr.cea.nabla.nabla.Real2x2Constant#getY <em>Y</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
