...
import static kaulua.rename.RefactoringIssueAcceptor.Severity.*
...
class RenameService {
	...
	def rename(Document document, XtextResource xtextResource, RenameParams renameParams, CancelIndicator cancelIndicator) {
