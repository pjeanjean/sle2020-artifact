 ...
 * </p>
 * <ul>
 *   <li>{@link fr.cea.nabla.nabla.Real3x3Constant#getX <em>X</em>}</li>
 *   <li>{@link fr.cea.nabla.nabla.Real3x3Constant#getY <em>Y</em>}</li>
 *   <li>{@link fr.cea.nabla.nabla.Real3x3Constant#getZ <em>Z</em>}</li>
 * </ul>
 *
 * @see fr.cea.nabla.nabla.NablaPackage#getReal3x3Constant()
 * @model
 * @generated
 */
public interface Real3x3Constant extends Expression
{
   ...
   * @see fr.cea.nabla.nabla.NablaPackage#getReal3x3Constant_X()
  ...
  /**
   * Sets the value of the '{@link fr.cea.nabla.nabla.Real3x3Constant#getX <em>X</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.cea.nabla.nabla.NablaPackage#getReal3x3Constant_Y()
   * @model containment="true"
   * @generated
   */
  Real3Constant getY();
  ...
  /**
   * Sets the value of the '{@link fr.cea.nabla.nabla.Real3x3Constant#getY <em>Y</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.cea.nabla.nabla.NablaPackage#getReal3x3Constant_Z()
   * @model containment="true"
   * @generated
   */
  Real3Constant getZ();
  ...
  /**
   * Sets the value of the '{@link fr.cea.nabla.nabla.Real3x3Constant#getZ <em>Z</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
