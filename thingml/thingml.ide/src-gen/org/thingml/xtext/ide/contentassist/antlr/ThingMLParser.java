...
public class ThingMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ThingMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNamedElementAccess().getGroup_14(), "rule__NamedElement__Group_14__0");
			...
			builder.put(grammarAccess.getNamedElementAccess().getNameAssignment_14_1(), "rule__NamedElement__NameAssignment_14_1");
