...
import org.tetrabox.minijava.xtext.ide.MinijavaLSPModule;
...
public class ServerSocket {
	...
	LanguageServerImpl server = new MinijavaLSPModule().createInjectorAndDoEMFRegistration().getInstance(LanguageServerImpl.class);
