...
public class AppLifecycleBean {
	...
	static kaulua.lsp.api.IWorkspace service;
	
	void onStart(@Observes StartupEvent ev) {
		LOGGER.info("workspace is starting...");
		getService();
	}

	void onStop(@Observes ShutdownEvent ev) { //
		LOGGER.info("workspace is stopping...");
	}
	
	public static kaulua.lsp.api.IWorkspace getService() {
		if(service == null) {
			...
			service = injector.getInstance(kaulua.lsp.api.IWorkspace.class);
