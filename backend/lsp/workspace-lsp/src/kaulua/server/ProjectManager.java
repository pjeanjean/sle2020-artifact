...
public class ProjectManager {
	...
	public IncrementalBuilder.Result doBuild(List<URI> dirtyFiles, List<URI> deletedFiles,
		...
		System.out.println("[DEBUG DO_BUILD] " + dirtyFiles);
		
		if(!dirtyFiles.isEmpty()) {
			Object res = request.getResourceSet().getResource(dirtyFiles.get(0), true);
			System.out.println("[DEBUG DO_BUILD] " + res);
		}
		
//		context.oldState.resourceDescriptions
//		context
//		incrementalBuilder.getDeltasForChangedResources(request.getDirtyFiles(),)
